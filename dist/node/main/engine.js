...
function _applyTransforms() {
  _applyTransforms = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee10(value, transforms, direction) {
    var ordered, next, _iterator2, _step2, transform, handler, _t5;
...
function _serializeValue() {
  _serializeValue = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee11(value, config) {
    var msgpack;
    return _regenerator["default"].wrap(function (_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          return _context11.abrupt("return", JSON.stringify(value));
        case 1:
          _context11.next = 2;
          return _loaders["default"].msgpack();
        case 2:
          msgpack = _context11.sent;
          return _context11.abrupt("return", msgpack.encode(value));
        case 3:
        case "end":
...
function _deserializeValue() {
  _deserializeValue = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee12(value, config) {
    var msgpack;
    return _regenerator["default"].wrap(function (_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 1:
          ...
          return _loaders["default"].msgpack();
        case 2:
          msgpack = _context12.sent;
          return _context12.abrupt("return", msgpack.decode(value));
        case 3:
        case "end":
...
function _encodeCompressedValue() {
  _encodeCompressedValue = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee13(value, config) {
    var safe64;
    return _regenerator["default"].wrap(function (_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 2:
          safe64 = _context13.sent;
          return _context13.abrupt("return", safe64.encode(value));
        case 3:
        case "end":
...
function _decodeCompressedValue() {
  _decodeCompressedValue = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee14(value, config) {
    var safe64;
    return _regenerator["default"].wrap(function (_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 1:
          ...
          return _loaders["default"].safe64();
        case 2:
          safe64 = _context14.sent;
          return _context14.abrupt("return", safe64.decode(value));
        case 3:
        case "end":
...
function createNamedCodec(algorithm) {
      ...
      return _regenerator["default"].wrap(function (_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            normalized = (0, _decodeUtils.prepareEncodedInput)(string, options);
            _context3.next = 1;
            return decodeCompressedValue(normalized, config);
          case 1:
  ...
  function tryDecompress(_x13, _x14) {
    return _tryDecompress.apply(this, arguments);
  }
  function _tryDecompress() {
    _tryDecompress = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(string, fallback) {
      var options,
        _args4 = arguments,
        _t;
      return _regenerator["default"].wrap(function (_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 2;
            return decompress(string, options);
          case 2:
  ...
  function _stats() {
    _stats = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(json) {
      ...
      return _regenerator["default"].wrap(function (_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return prepareInput(json);
          case 1:
            _yield$prepareInput2 = _context5.sent;
            transformedText = _yield$prepareInput2.transformedText;
            _context5.next = 2;
            return compress(json);
          case 2:
            token = _context5.sent;
            return _context5.abrupt("return", _objectSpread(_objectSpread({}, createStats({
              rawText: rawText,
...
function createEngine() {
  ...
  function prepareInput(_x16) {
    return _prepareInput2.apply(this, arguments);
  }
  function _prepareInput2() {
    _prepareInput2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee6(json) {
      var transformed;
  ...
  function compressDetailed(_x17) {
    return _compressDetailed.apply(this, arguments);
  }
  function _compressDetailed() {
    _compressDetailed = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee7(json) {
      var _yield$prepareInput3, rawText, transformed, transformedText, rawencoded, transformedencoded, candidates, skipped, _iterator, _step, entry, payload, token, best, _t2, _t3;
      return _regenerator["default"].wrap(function (_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return prepareInput(json);
          case 1:
            _yield$prepareInput3 = _context7.sent;
          ...
          case 7:
            ...
            if (!(!skipUnsupportedCodecs || !isUnsupportedCodecError(_t2))) {
              _context7.next = 8;
              break;
            }
            throw _t2;
      ...
      }, _callee7, null, [[2, 11, 12, 13], [4, 7]]);
    }));
    return _compressDetailed.apply(this, arguments);
  }
  function compress(_x18) {
    return _compress2.apply(this, arguments);
  }
  function _compress2() {
    _compress2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee8(json) {
      var result;
  ...
  function decompress(_x19) {
    return _decompress2.apply(this, arguments);
  }
  function _decompress2() {
    _decompress2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee9(token) {
      var options,
        normalized,
        parsed,
        _decoded,
      ...
      return _regenerator["default"].wrap(function (_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            normalized = (0, _decodeUtils.prepareEncodedInput)(token, options);
            parsed = parseToken(normalized);
          ...
          case 1:
            ...
            return _context9.abrupt("return", applyTransforms(_decoded, transforms, 'decode'));
          case 2:
          ...
          case 5:
            _context9.next = 6;
            return codecMap.get(defaultCodec).client.decompress(normalized);
          case 6:
            decoded = _context9.sent;
            return _context9.abrupt("return", applyTransforms(decoded, transforms, 'decode'));
          case 7:
          case "end":
  ...
  function tryDecompress(_x20, _x21) {
    return _tryDecompress2.apply(this, arguments);
  }
  function _tryDecompress2() {
    _tryDecompress2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee0(token, fallback) {
      var options,
        _args0 = arguments,
        _t4;
      return _regenerator["default"].wrap(function (_context0) {
        while (1) switch (_context0.prev = _context0.next) {
          case 0:
            ...
            _context0.prev = 1;
            _context0.next = 2;
            return decompress(token, options);
          case 2:
            return _context0.abrupt("return", _context0.sent);
          case 3:
            _context0.prev = 3;
            _t4 = _context0["catch"](1);
            return _context0.abrupt("return", fallback);
          case 4:
          case "end":
  ...
  function _stats2() {
    _stats2 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee1(json) {
      return _regenerator["default"].wrap(function (_context1) {
        while (1) switch (_context1.prev = _context1.next) {
          case 0:
            return _context1.abrupt("return", compressDetailed(json));
          case 1:
          case "end":
